...
func (cfg *config) start1(i int) {
	...
	//fmt.Printf("Make a new raft %d %v", i, ends[i])
...
func (cfg *config) connect(i int) {
	...
	for j := 0; j < cfg.n; j++ {
		if cfg.connected[j] {
			...
			//fmt.Printf("connected outgoing endname %s\n", endname)
	...
	for j := 0; j < cfg.n; j++ {
		if cfg.connected[j] {
			...
			//fmt.Printf("connected incoming endname %s\n", endname)
			cfg.net.Enable(endname, true)
		}
	}
}
...
func (cfg *config) disconnect(i int) {
	...
	for j := 0; j < cfg.n; j++ {
		if cfg.endnames[i] != nil {
			endname := cfg.endnames[i][j]
			//fmt.Printf("disconnected outgoing endname %s\n", endname)
	...
	for j := 0; j < cfg.n; j++ {
		if cfg.endnames[j] != nil {
			endname := cfg.endnames[j][i]
			//fmt.Printf("disconnected incoming endname %s\n", endname)
			cfg.net.Enable(endname, false)
		}
	}
}
...
func (cfg *config) wait(index int, n int, startTerm int) interface{} {
	...
	log.Printf("\033[1;34m committed %d index %d %v \033[0m", nd, index, cmd)
	if nd < n {
